...
description: Refactor Angular components in this project - consolidate styles, extract child/shared components, and apply standard Angular best practices.
---
...
5. After each file is complete, dispatch the `zone-auditor` agent against it to verify zoneless compliance.

### 5 — Verify

After all changes:
- Dispatch the `build-runner` agent to confirm zero errors and zero warnings.
